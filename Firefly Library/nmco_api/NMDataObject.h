...
enum	NMLOCALEID
{
	...
	kLocaleID_CN2 			= 0x00000107,	//	China 2
	kLocaleID_ID2 			= 0x00000108,	//	Indonesia 2
...
enum NMREGIONCODE
{
	...
	kRegionCode_CT6 = 0x6,
	kRegionCode_CT7 = 0x7,
	kRegionCode_CNC1 = 0xB,
	kRegionCode_CNC2 = 0xC,
	kRegionCode_CNC3 = 0xD,
	kRegionCode_CNC4 = 0xE,
	kRegionCode_CNC5 = 0xF,
	kRegionCode_CNC6 = 0x10,
	kRegionCode_CGZ1 = 0x1E,
	kRegionCode_CGZ2 = 0x1F,
	kRegionCode_CQD1 = 0x20,
	kRegionCode_CQD2 = 0x21,
	kRegionCode_CSH1 = 0x22,
	kRegionCode_CSH2 = 0x23,
	kRegionCode_CTJ1 = 0x24,
	kRegionCode_CTJ2 = 0x25,
	kRegionCode_CCD1 = 0x26,
	kRegionCode_CCD2 = 0x27,
	kRegionCode_CXA1 = 0x28,
	kRegionCode_CSJZ1 = 0x29,
	kRegionCode_CSX1 = 0x2A,
	kRegionCode_COT1 = 0x2B,
	kRegionCode_NPNA1 = 0x64,
	kRegionCode_NXA1 = 0xC8,
	kRegionCode_NXA2 = 0xC9,
	kRegionCode_NXA3 = 0xCA,
	kRegionCode_NXA4 = 0xCB,
	kRegionCode_TW2 = 0x12C,
	kRegionCode_TH1 = 0x190,
	kRegionCode_JP2 = 0x1F4,
	kRegionCode_JP3 = 0x1F5,
	kRegionCode_JP4 = 0x1F6,
	kRegionCode_JP5 = 0x1F7,
	kRegionCode_JP6 = 0x1F8,
	kRegionCode_JP7 = 0x1F9,
	kRegionCode_JP8 = 0x1FA,
	kRegionCode_EU1 = 0x258,
	kRegionCode_EU2 = 0x259,
	kRegionCode_EU3 = 0x25A,
	kRegionCode_VN1 = 0x2BC,
	kRegionCode_RU1 = 0x320,
	kRegionCode_BR1 = 0x384,
	kRegionCode_SG1 = 0x3E8,
	kRegionCode_SNDA1 = 0x44C,
	kRegionCode_SNDA2 = 0x44D,
	kRegionCode_SNDA3 = 0x44E,
	kRegionCode_SNDA4 = 0x44F,
	kRegionCode_SNDA5 = 0x450,
	kRegionCode_ID1 = 0x4B0,
	kRegionCode_ID2 = 0x4B1,
};
...
enum
{
	...
	kSubGameCode_maplestory			= 0x2213,
	...
	kSubGameCode_sampoom 			= 0x701C,
	kSubGameCode_ageofhero			= 0x701D,
	...
	// for installation
	kSubGameCode_maple_install		= 0x1,
	kSubGameCode_maplet_install		= 0x2,
	kSubGameCode_qplay_install		= 0x1,
	kSubGameCode_ca_install			= 0x1,
	kSubGameCode_lod_install		= 0x1,
	kSubGameCode_planb				= 0x1,
};
...
enum
{
	...
	kGameCode_nexonus			= MAKE_GAMECODE( kMainGameCode_nexon_us		, kSubGameCode_NULL ),
	...
	kGameCode_maplestory_us		= MAKE_GAMECODE( kMainGameCode_nexon_us		, kSubGameCode_maplestory ),
...
{	//	Reply code for login result to authentication server
	...
	kLoginAuth_GameServerInspection		= 20030,
	kLoginAuth_TempUserLoginBlocked		= 20031,
	kLoginAuth_NeedMatrixLogin			= 20032,
	kLoginAuth_WrongSecurityData		= 20033,
	kLoginAuth_AlreadyLoggedIn			= 20037,
	kLoginAuth_SecureDataNotExist 		= 20038,
	kLoginAuth_InvalidOtpData 			= 20039,
	kLoginAuth_NotRegisteredPC 			= 20040,
	kLoginAuth_NeedSecureData 			= 20041,
	kLoginAuth_RegisteredPC 			= 20042,
	kLoginAuth_Timeout 					= 20043,
	kLoginAuth_PasswordExpired 			= 20044,
	kLoginAuth_NotVerified 				= 20045,
	kLoginAuth_BlockedBySuspiciousIP	= 20046,
	kLoginAuth_ForcePasswordExpired 	= 20047,
	kLoginAuth_LowLevelPassport			= 20048,
	kLoginAuth_GameCodeMismatch 		= 20049,
	kLoginAuth_InvalidHWID 				= 20050,
	kLoginAuth_UserNotExistsBlockparty 	= 20051,
	kLoginAuth_BlockedByServiceArea 	= 20052,
	kLoginAuth_ExpiredByServiceArea 	= 20053,
	kLoginAuth_BlockedByLongInactivated = 20054,
	kLoginAuth_ExpiredByLongInactivated	= 20055,
	kLoginAuth_ChargeBackUser			= 20057,
	kLoginAuth_ErrorBySafeLogin			= 20059,
	kLoginAuth_EMailVerify			 	= 20064,
	kLoginAuth_GuestServiceClosed 		= 20063,
	kLoginAuth_ProtectedAccount 		= 20076,
	kLoginAuth_InactivateMember 		= 20077,
